...
public class InterpretadorTituloBancoDoBrasilConvenio7Posicoes extends InterpretadorTitulo {

    private static final long serialVersionUID = -3527598342657604683L;

    public InterpretadorTituloBancoDoBrasilConvenio7Posicoes(final String codigoDeBarras) {
        super(codigoDeBarras);
    }

    @Override
    public boolean isValidoParaInterpretacao() {
        return InstituicaoFinanceira.BANCO_DO_BRASIL.equals(this.getInstituicaoFinanceira()) && this.getCodigoDeBarras().substring(19, 25).equals("000000");
    }
